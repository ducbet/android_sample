...
public final class HiddenCameraUtils {
    ...
    static File getCacheDir(Context context) {
        return context.getExternalCacheDir() == null ? context.getCacheDir() :
     ...
     */
    @WorkerThread
    static Bitmap rotateBitmap(@NonNull Bitmap bitmap,
                               @CameraRotation.SupportedRotation int rotation) {
    ...
    static boolean saveImageFromFile(@NonNull Bitmap bitmap,
        ...
        try {
            ...
            isSuccess = true;
            Log.e("MY_TAG", "saveImageFromFile: success");
        } catch (Exception e) {
            e.printStackTrace();
            isSuccess = false;
            Log.e("MY_TAG", "saveImageFromFile: false");
        } finally {
            try {
