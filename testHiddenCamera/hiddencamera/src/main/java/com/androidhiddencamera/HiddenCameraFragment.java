...
public abstract class HiddenCameraFragment extends Fragment implements CameraCallbacks {
    ...
    public void startCamera(CameraConfig cameraConfig) {
        if (ActivityCompat.checkSelfPermission(getActivity(), Manifest.permission.CAMERA)
            ...
            && !HiddenCameraUtils
            .isFrontCameraAvailable(getActivity())) {   //Check if for the front camera
    ...
    public void stopCamera() {
        ...
        if (mCameraPreview != null) {
            Log.e("MY_TAG", "HiddenCameraFragment: stopCamera");
    ...
    private CameraPreview addPreView() {
        ...
        if (view instanceof LinearLayout) {
            ...
            throw new RuntimeException(
                "Root view of the activity/fragment cannot be other than Linear/Relative or frame layout");
        }
    ...
    public void onPause() {
        super.onPause();
        if (mCameraPreview != null) {
            Log.e("MY_TAG", "HiddenCameraFragment: onPause");
            mCameraPreview.stopPreviewAndFreeCamera();
        }
    }
}