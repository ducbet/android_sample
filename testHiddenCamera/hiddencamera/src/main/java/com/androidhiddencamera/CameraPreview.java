...
class CameraPreview extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public void surfaceChanged(SurfaceHolder surfaceHolder, int i, int i1, int i2) {
        ...
        switch (mCameraConfig.getResolution()) {
            ...
            case CameraResolution.MEDIUM_RESOLUTION:
                cameraSize =
                    pictureSizes.get(pictureSizes.size() / 2);     //Resolution at the middle
                break;
    ...
    private boolean safeCameraOpen(int id) {
        ...
        try {
            Log.e("MY_TAG", "CameraPreview: safeCameraOpen");
                    ...
                    new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            if (mCameraConfig.getmImageRotation() != CameraRotation.ROTATION_0) {
                                rotatedBitmap = HiddenCameraUtils
                                    .rotateBitmap(bitmap, mCameraConfig.getmImageRotation());
                            ...
                            if (HiddenCameraUtils.saveImageFromFile(rotatedBitmap,
                                ...
                                new android.os.Handler(Looper.getMainLooper()).post(new Runnable() {
                                    ...
                                    public void run() {
                                        mCameraCallbacks
                                            .onImageCapture(mCameraConfig.getImageFile());
                                    }
                                });
                            } else {
    ...
    void stopPreviewAndFreeCamera() {
        Log.e("MY_TAG", "stopPreviewAndFreeCamera");
        safeToTakePicture = false;
        if (mCamera != null) {
            mCamera.stopPreview();
            mCamera.release();
